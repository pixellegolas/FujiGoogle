...
interface ControlBarProps {
  ...
  livePreview: boolean;
  onToggleLivePreview: (val: boolean) => void;
  onTakePhoto: () => void;
  ...
  return (
    <>
      ...
      >
        ...
        {/* Höger sida: Checkbox för att toggla live-preview av film recipes */}
        <div className="flex-1 flex flex-col items-end justify-center pl-2">
          <label
            htmlFor="live-preview-checkbox"
          ...
          >
            ...
            <div className="relative">
              ...
              >
                {livePreview && <Check className="w-3.5 h-3.5 stroke-[3]" />}
              </div>
            </div>
          </label>
        </div>
